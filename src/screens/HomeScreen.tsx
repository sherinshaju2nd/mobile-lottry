    ...
    <SafeAreaView style={styles.safeArea} edges={["top", "left", "right"]}>
      ...
      >
        ...
        <View style={styles.seoContainer}>
          <Text style={styles.seoTitle}>Kerala Lottery Results Today – Live Winning Numbers & Details</Text>
          <Text style={styles.seoText}>If you're searching for the kerala lottery results today, you've landed on the right app. This app publishes the kerala lottery result today the moment the official draw closes, so you never have to dig through old posts to find your kerala lottery results today result. Whether you're tracking today kerala lottery result for a routine weekly draw or the kerala lottery ticket result today for a specific series, everything here is organised by date, draw name and prize tier.</Text>

          <Text style={styles.seoSubtitle}>When Does the Draw Go Live?</Text>
          <Text style={styles.seoText}>The lottery result today kerala telecast begins at 2:55 PM on Kairali TV, Kaumudy TV and Jai Hind TV, and the full today's kerala lottery result sheet — first prize down to consolation — is usually finalised between 3:00 PM and 4:30 PM. Our today lottery result kerala table refreshes automatically as the Directorate confirms each tier, so the kerala result today lottery list you see is always the verified, official one.</Text>
          
          <Text style={styles.seoSubtitle}>Today's Draw, by Lottery Name</Text>
          <Text style={styles.seoText}>Kerala runs a different lottery each day. The win win lottery result today kerala publishes every Monday, Tuesday belongs to kerala lottery result today sthree sakthi, Wednesday to kerala lottery result today karunya plus, and Thursday to kerala lottery result today nirmal. Friday is kerala lottery result today karunya, and Saturday brings kerala lottery result today fifty fifty.</Text>
          
          <Text style={styles.seoSubtitle}>Checking Your Ticket</Text>
          <Text style={styles.seoText}>To find the lottery result kerala today for your ticket, use the search bar or browse by draw name. What we provide is the confirmed kerala lottery results today live results today feed, cross-checked against the government gazette.</Text>
          
          <Text style={styles.seoSubtitle}>Jackpots and Big Wins</Text>
          <Text style={styles.seoText}>The number one thing readers want is the kerala lottery result today jackpot, and we lead every screen with it. You'll find the kerala lottery jackpot result today, the kerala jackpot lottery result today, and the jackpot kerala lottery result today figure right at the top of today's card.</Text>
          
          <Text style={styles.seoSubtitle}>A Note on Accuracy</Text>
          <Text style={styles.seoText}>Every number on this app is pulled from the official gazette published by the Directorate of Kerala State Lotteries. Results are published for informational purposes. Always verify winning numbers against the official Kerala State Lotteries gazette before making any prize claim.</Text>
        </View>
      </ScrollView>
    </SafeAreaView>
  );
...
const styles = StyleSheet.create({
  ...
  seoContainer: { marginTop: 24, paddingTop: 16, borderTopWidth: 1, borderTopColor: COLORS.border, paddingHorizontal: 4 },
